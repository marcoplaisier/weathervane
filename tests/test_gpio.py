...
class TestGPIO(unittest.TestCase):
    def test_init_both_pins_and_spi(self, mock_loader):
        gpio = GPIO(channel=0, frequency=500000, library='wiringPi', interrupt=4)
    ...
    def test_gpio_context_manager(self, mock_loader):
        with GPIO(channel=0, frequency=10000, library='None', interrupt=0).cm() as g:
    ...
    def test_constructor(self, mock_loader):
        ...
        with GPIO(channel=0, frequency=0, library='wiringPi', interrupt=0).cm() as g:
            self.assertTrue(g)